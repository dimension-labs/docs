...
[Accounts](../design/accounts.md) on a Dimension Network can associate other accounts to allow or require a multiple signature scheme for deploys.
...
5.  You have previously [deployed a smart contract](../dapp-dev-guide/deploying-contracts.md) to a Dimension Network
