...
This is the Writing Style Guide used by Dimension's documentation team.
...
The DimensionLabs Writing and Editing Style Guide aims to establish a set of standards and guidelines for writing and editing DimensionLabs documents to provide uniformity and consistency throughout. This document briefly discusses the guidelines to be followed in developing the content for each deliverable. The official language to be used in all DimensionLabs documents is American English, thus for spelling variations [Merriam Webster Dictionary](https://www.merriam-webster.com/dictionary/dictionary) will be the reference point.

---

## General Guidelines {#general-guidelines}

* Use Dimension not dimension.

* Use DimensionLabs instead of Dimension Labs, dimension labs, dimensionLabs, dimensionlabs, or any other variation.

* Use Dimension Network (the initial letter of both words capitalized) while referring to the Dimension blockchain network.
...
> To use this example on the Mainnet, replace *chain-name* as dimension.
```

```
:::note

Alternatively, you can use this link to download the DimensionLabs Signer.
...
* Use italic formatting for directory names (such as *nctl*, *dimension-node*), key names (such as *public key*, *secret key*), and hashes (such as *account hash*, *deploy hash*).
