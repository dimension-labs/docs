...
2.  Use the Dimension [command-line client](/workflow/setup#the-dimension-command-line-client)
...
```
dimension-client get-state-root-hash --node-address [NODE_SERVER_ADDRESS]
```
**Note**
