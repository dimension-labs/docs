...
Review the [deploy data structure](https://docs.dimensionlabs.io/en/latest/implementation/serialization-standard.html?highlight=deploy#deploy) and the [deploy implementation](https://github.com/dimension-labs/dimension-node/blob/master/node/src/types/deploy.rs#L475) for more details.
