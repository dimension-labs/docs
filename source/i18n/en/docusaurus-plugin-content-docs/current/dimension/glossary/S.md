...
A feature of Proof-of-Stake protocols that allows token holders to actively participate in the protocol, thus securing the network. The [Staking Guide](https://docs.dimensionlabs.io/en/latest/staking/index.md) highlights the steps required to stake the DSCC token on the Dimension network.
