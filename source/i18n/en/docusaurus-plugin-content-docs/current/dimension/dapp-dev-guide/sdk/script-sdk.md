...
The [TypeScript/JavaScript SDK](https://dimension-labs.github.io/dimension-js-sdk/next) allows developers to interact with the Dimension Network using TypeScript or JavaScript. This page covers different examples of using the SDK.
...
For a complete implementation example, read the [Multi-Signature Tutorial](https://docs.dimensionlabs.io/en/latest/dapp-dev-guide/tutorials/multi-sig/index.html), which uses the JavaScript SDK.
