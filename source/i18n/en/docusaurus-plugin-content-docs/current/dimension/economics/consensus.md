...
Currently, delegation is unrestricted. Interested readers should review [CEP #29](https://github.com/dimension-labs/ceps/pull/29), which proposes delegation caps.
...
DSCC is issued at a fixed rate and distributed to validators (and, indirectly, delegators) in proportion to their stake. This is analogous to block rewards in Proof-of-Work blockchains, outlining the following:

-   The growth of DSCC supply is exponential
...
-   `initial_supply` - the number of DSCC at genesis
-   `issuance_rate` - the annual rate at which new DSCC tokens are minted
...
This value gives us the maximum amount of DSCC that the validators can collectively receive from a proposed block.
...
Please review our [Equivocator Policy](https://github.com/dimension-labs/ceps/blob/master/text/0038-equivocator-policy.md). We are currently conducting research into the utility of slashing as an incentive mechanism.
